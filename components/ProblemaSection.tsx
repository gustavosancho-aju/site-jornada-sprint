    ...
    <div className="container mx-auto max-w-6xl px-4">
      ...
      <div className="grid md:grid-cols-3 gap-6 relative z-10">
        <div className="reveal reveal-delay-1 card-3d-hover card-highlight bg-black/90 p-8 rounded-2xl text-white shadow-xl border border-white/10 hover:border-brand-green/50 transition-colors duration-300 group">
          ...
          <p className="text-slate-400 leading-relaxed text-base md:text-lg">Você vai montar assistentes de IA que executam o trabalho repetitivo por você: triagem de e-mail, relatórios automáticos, atendimento no WhatsApp. Enquanto você dorme, a automação trabalha. Não é ficção — é o coração da Jornada Sprint.</p>
        </div>
